...
const gravity = 0.7;
const background_images = ['./img/game_background.jpg', './img/game_background.png', './img/background(1).jpg'];
let game_background = new Sprite({
    position: {
        x: 0,
        y: 0
    },
    imageSrc: background_images[Math.floor(Math.random() * background_images.length)]
});
...
function resetSprites() {
    ...
    // Update game_background with a new random background image
    game_background = new Sprite({
        position: {
            x: 0,
            y: 0
        },
